...
file_dir = 'raw'    # Location of raw EQ data
...
for root, dirs, files in os.walk(file_dir):
    for file in sorted(files):
        ...
        if os.path.splitext(file)[1] == '.NS':      ## North-South
        ...
        if os.path.splitext(file)[1] == '.UD':      ## Up-Down
            ...
            # Convert [gal] to [g] (https://www.kyoshin.bosai.go.jp/cgi-bin/kyoshin/auth/makearc?1)
